  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        <div className="w-full bg-cover bg-center bg-no-repeat h-96" style={{ backgroundImage: 'url("https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/banners/corporate-events-banner.jpg")' }}>
          <div className="md:max-h-96 h-full xl:max-h-96 md:min-h-96 flex items-center justify-start bg-opacity-50 px-5 md:px-20 bg-no-repeat bg-cover bg-top">
            <div className='block'>
              <div className="text-black text-6xl font-semibold max-sm:text-xl">FOCUS ON YOUR ATTENDEES, <br /> WE’LL RUN THE SHOW</div>
        ...
        <div className="max-w-4xl mx-auto my-20 pb-10 block">
          <div className="flex flex-col md:flex-row justify-between items-center md:p-10">
            <div className="w-full p-10 md:w-1/5 max-w-15 mx-auto md:max-w-full md:mx-none order-1 md:order-2">
              <img alt="events" src="https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/icons/conferences.svg" decoding="async" />
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:p-10 border-t border-dashed border-gray mt-10">
            <div className="w-full p-10 md:w-1/5 max-w-15 mx-auto md:max-w-full md:mx-none">
              <img alt="events" src="https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/icons/product-launch.svg" decoding="async" />
            </div>
            <div className="w-full md:w-4/5 text-center md:text-left md:max-w-116.5 block md:hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:p-10 border-t border-dashed border-gray mt-10">
            <div className="w-full p-10 md:w-1/5 max-w-15 mx-auto md:max-w-full md:mx-none order-1 md:order-2">
              <img alt="events" src="https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/icons/networking.svg" decoding="async" />
            </div>
            <div className="w-full md:w-4/5 text-center md:text-left md:max-w-116.5 block md:hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:p-10 border-t border-dashed border-gray mt-10">
            <div className="w-full p-10 md:w-1/5 max-w-15 mx-auto md:max-w-full md:mx-none">
              <img alt="events" src="https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/icons/team-building.svg" decoding="async" />
            </div>
            <div className="w-full md:w-4/5 text-center md:text-left md:max-w-116.5 block md:hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:p-10 border-t border-dashed border-gray mt-10 last:pb-0">
            <div className="w-full p-10 md:w-1/5 max-w-15 mx-auto md:max-w-full md:mx-none order-1 md:order-2">
              <img alt="events" src="https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/icons/festivals.svg" decoding="async" />
            </div>
            <div className="w-full md:w-4/5 text-center md:text-left md:max-w-116.5 block md:hidden">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center md:p-10 border-t border-dashed border-gray mt-10">
            <div className="w-full p-10 md:w-1/5 max-w-15 mx-auto md:max-w-full md:mx-none">
              <img alt="events" src="https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/icons/sports-event.svg" decoding="async" />
            </div>

            <div className="w-full md:w-4/5 text-center md:text-left md:max-w-116.5">
              <div className="hidden md:block">
                <h3 className="capitalize text-lg md:text-28px font-normal font-Montserrat text-black leading-5 md:leading-8 mb-2"> Sports Events </h3>
                <div className="border-solid border-b-2 border-nero w-5 md:w-15 mb-3 md:mb-7" />
              </div>
              <p className="text-sm md:text-base font-medium text-dim-gray">Ready, steady, Hafla! Focus on the game and let us handle the rest..</p>
              <p className="italic text-sm md:text-base font-medium text-dim-gray mt-4">Food &amp; Bar Counter / Furniture / Garden Decoration / DJ Night</p>
            </div>
          </div>
      ...
      <div className="flex bg-white py-10 flex-col md:flex-row justify-around items-start md:items-center">
        <div>
          <div className="flex flex-row items-center">
            <div className="font-google-basic text-lg md:text-4xl text-nero uppercase leading-8 lg:leading-16 text-start tracking-wider flex flex-row" style={{ letterSpacing: 4 }}>SOME OF OUR PAST CORPORATE EVENTS</div>
      ...
      <div className="w-full max-w-68 mx-auto md:max-w-full md:w-1/2 md:flex md:flex-wrap justify-center items-center pt-4 md:pt-10">
        ...
        <div className="max-w-screen-2xl px-24 my-10 mx-auto relative">
          ...
          <Slider {...settings}>
            ...
            <div className="px-4">
              <div className="relative cursor-pointer rounded-lg overflow-hidden flex-shrink-0 me-3 w-96 h-40 md:h-80 md:w-96 bg-cover" style={{ backgroundImage: 'url("https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/gallery/corporate-events/Sales%20Events%20Shobha%20Developers(2).jpeg")' }} onClick={() => toggleModal('https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/gallery/corporate-events/Sales%20Events%20Shobha%20Developers(2).jpeg')} >
                <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-0 hover:bg-opacity-70 transition duration-500 ease-in-out opacity-0 hover:opacity-100">
            ...
            <div className="px-4">
              <div className="relative cursor-pointer rounded-lg overflow-hidden flex-shrink-0 me-3 w-96 h-40 md:h-80 md:w-96 bg-cover" style={{ backgroundImage: 'url("https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/gallery/corporate-events/Product%20Launch%20Danube%20Properties.jpeg")' }} onClick={() => toggleModal('https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/gallery/corporate-events/Product%20Launch%20Danube%20Properties.jpeg')}>
                <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-0 hover:bg-opacity-70 transition duration-500 ease-in-out opacity-0 hover:opacity-100">
            ...
            <div className="px-4">
              <div className="relative cursor-pointer rounded-lg overflow-hidden flex-shrink-0 me-3 w-96 h-40 md:h-80 md:w-96 bg-cover" style={{ backgroundImage: 'url("https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/gallery/corporate-events/Resortz%20Launch%20Danube.jpeg")' }} onClick={() => toggleModal('https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/gallery/corporate-events/Resortz%20Launch%20Danube.jpeg')}>
                <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-0 hover:bg-opacity-70 transition duration-500 ease-in-out opacity-0 hover:opacity-100">
            ...
            <div className="px-4">
              <div className="relative cursor-pointer rounded-lg overflow-hidden flex-shrink-0 me-3 w-96 h-40 md:h-80 md:w-96 bg-cover" style={{ backgroundImage: 'url("https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/gallery/corporate-events/Ramadan%20Event%20McKinsey.jpeg")' }} onClick={() => toggleModal('https://s3.ap-south-1.amazonaws.com/production.media.hafla.com/static_images/host/gallery/corporate-events/Ramadan%20Event%20McKinsey.jpeg')}>
                <div className="absolute inset-0 flex justify-center items-center bg-black bg-opacity-0 hover:bg-opacity-70 transition duration-500 ease-in-out opacity-0 hover:opacity-100">
                  <p className="text-white text-sm md:text-lg font-semibold leading-4 max-w-72">PIRATE-BDAY-THEME2</p>
                </div>
              </div>
